...
public class BookControllerSecurityTest extends AbstractControllerTest {
	...
	private static Stream<Arguments> urlProvider() {
		String getAll = "/books";
		String add = "/books/add";
		String edit = "/books/edit/1";
		...
		return Stream.of(
			...
			Arguments.of(HttpMethod.GET, add, userWithRoleAuthorManager, forbiddenStatus),
			Arguments.of(HttpMethod.GET, add, userWithRoleBookManager, okStatus),
			...
			Arguments.of(HttpMethod.GET, edit, userWithRoleAuthorManager, forbiddenStatus),
			Arguments.of(HttpMethod.GET, edit, userWithRoleBookManager, okStatus),
