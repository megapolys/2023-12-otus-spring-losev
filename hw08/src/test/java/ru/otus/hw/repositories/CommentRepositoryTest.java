...
public class CommentRepositoryTest {
	...
	void setup() {
		...
		commentRepository.save(new Comment("1", "Comment_1", bookRepository.findById("1").get()));
		commentRepository.save(new Comment("2", "Comment_2", bookRepository.findById("1").get()));
		commentRepository.save(new Comment("3", "Comment_3", bookRepository.findById("3").get()));
	}
